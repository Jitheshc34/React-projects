    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white pt-10'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/axojezkb" method="POST" className='flex flex-col w-full md:w-1/2'>
                    <input 
                        type="text"
                        name="name"
                    ...
                    flex items-center rounded-md hover:scale-110 duration-300'>Let's discuss</button>
